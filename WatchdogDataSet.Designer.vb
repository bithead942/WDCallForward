...
Namespace WatchdogDataSetTableAdapters
    ...
    Partial Public Class Event_Current_StateTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT Row_ID, House_Occupied FROM dbo.Event_Current_State"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where Row_ID = 1"
        ...
        Public Overloads Overridable Function FillHouseOccupied(ByVal dataTable As WatchdogDataSet.Event_Current_StateDataTable) As Integer
        ...
        Public Overloads Overridable Function GetHouseOccuiped() As WatchdogDataSet.Event_Current_StateDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As WatchdogDataSet.Event_Current_StateDataTable = New WatchdogDataSet.Event_Current_StateDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
    ...
    Partial Public Class Event_HistoryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "DELETE from dbo.Event_History"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE Event_ID = @Event_ID AND Event_Timestamp = @"& _ 
                "Event_Timestamp"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Event_ID", Global.System.Data.SqlDbType.NChar, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "Event_ID", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Event_Timestamp", Global.System.Data.SqlDbType.DateTime, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "Event_Timestamp", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT        TOP (3) Event_ID, Event_Timestamp"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Event_History"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"O"& _ 
                "RDER BY Event_Timestamp DESC"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillLast3(ByVal dataTable As WatchdogDataSet.Event_HistoryDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetLast3() As WatchdogDataSet.Event_HistoryDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            Dim dataTable As WatchdogDataSet.Event_HistoryDataTable = New WatchdogDataSet.Event_HistoryDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        Public Overloads Overridable Function DeletePhoneLog(ByVal Event_ID As String, ByVal Event_Timestamp As Date) As Integer
